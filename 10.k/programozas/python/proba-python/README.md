# Próba-ágazati python feladatsor
...
5. A pytest ebben a könyvtárban "megtalálja" a test_python.py programot.
6. A pytest az első futás alkalmával létrehozza feladat.py fájlt.
7. Nyisd meg a feladat.py fájlt.
8. A feladat.py-ban levő feladatokat oldd meg.
9. Rendszeresen ments.
10. Egy-egy függvény definiálása után futtasd meg a pytest-et és ellenőrizd a munkádat.
12. A feladat beadásához a feladat.py fájlt töltsd fel ebbe a github repositoryba.
